# EventCalendar_App analysis fixture

This directory is a Git-tracked copy of the generated Understand Anything
analysis data for `EventCalendar_App`. It is included here so the analysis can
be reviewed and discussed independently of the source application repository,
where `.understand-anything/` is intentionally ignored by Git.
...
not a second copy of EventCalendar_App source code or temporary run logs.
