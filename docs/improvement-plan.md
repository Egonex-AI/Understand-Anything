...
> **実施状況（2026-08-30）**
>
> この文書の以降の節は、改修着手時点の計画と担当境界を記録したものです。
> 現在の実装状況は次のとおりです。
>
> | Issue | 状況 | 根拠 |
> | --- | --- | --- |
> | #1 explanation再生成・品質検証 | 完了 | `0900670` |
> | #2 左右分割コード解説ビュー | MVP完了 | `da26d8c` |
> | #3 定義元ジャンプ | 完了 | `38fd74e` |
> | #4 日本語化と初心者向けUX | 完了 | `8e36e30` |
> | #5 ペルソナ別解説 | 実装完了、fixture品質作業中 | `887827e` |
>
> #2 の行単位スクロール同期とオンデマンドAI解説は、承認済みの将来課題です。
> #5 は fixture の品質検証・コミット後に完了と扱います。upstream の Issue #664 と
>その作業ツリー変更は、このロードマップの対象外です。
